...
def optimize_envmap_for_scene(scene_path, data_path, out_path, evs, proj='latlong', mask_id=255):
    ...
    for frame in range(1, num_frames + 1):
        ...
        ref_img_0 = load_reference_images(scene_path.replace(data_path, out_path), evs, frame, "sphere_0") 
        ref_img_1 = load_reference_images(scene_path.replace(data_path, out_path), evs, frame, "sphere_1")
        ...
        #final render diffuse and mirror for ev -0
        recon = pol()
        recon = recon.squeeze(0)
